...
return [
    ...
    */
    'repositories' => [
        'database' => [
            'handler'    => Ubmvn\Settings\Repositories\DatabaseRepository::class,
            'connection' => null,
            'table'      => 'settings',
        ],
    ],
    ...
    */
    'casts'        => [
        Carbon\Carbon::class       => \Ubmvn\Settings\Casts\CarbonCast::class,
        Carbon\CarbonPeriod::class => \Ubmvn\Settings\Casts\CarbonPeriodCast::class,
    ],
